        ...
        for (int i = 0; i < length; i++) {
            ...
            if (character == COLOUR_INVOKER && i < length) {
                ...
                if (index < 16) {
                    ...
                    RenderUtil.colour(ColourUtil.alpha(textColour, colour.getAlpha()));
                } else if (index == 16)
                    obfuscated = true;
                else if (index == 17)
                    ...
                    underlined = false;
                    characterData = regularData;
                    RenderUtil.colour(ColourUtil.alpha(ColourUtil.multiply(Color.WHITE, shadow ? (float) 0.25 : 1), colour.getAlpha()));
                }
            } else {
